...
public class CostsTrackerForm extends JPanel
{
    ...
    public CostsTrackerForm(CardLayout cardLayout, JPanel container)
    {
        ...
        JLabel titleLabel = new JLabel("Costs Tracker");
        ...
        fieldsPanel.add(styledLabel("Hourly Wage:"));
        hourlyWageField = styledTextField();
        fieldsPanel.add(hourlyWageField);
        ...
        JButton submitButton = createStyledButton("Submit", new Color(0xC3D9F0), new Color(0x24406B), "/darkbluepaw.png");
        submitButton.addActionListener(e -> onSubmit());

        JButton clearButton = createStyledButton("Clear", new Color(0xF6DED0), new Color(0x4A2E3B), null);
        clearButton.addActionListener(e -> clearFields());

        JButton historyButton = createStyledButton("View History", new Color(0xF3C6BE), new Color(0x6B2E28), "/darkredpaw.png");
    ...
    private void onSubmit()
    {
        ...
        if (rent < 0 || amenities < 0 || groceries < 0)
        {
            JOptionPane.showMessageDialog(this, "Enter a number that is 0.0 or greater!  :)");
            return;
        }

        CostsTracker tracker;
        try
        {
            tracker = new CostsTracker(rent, amenities, groceries, hourlyWage);
        }
